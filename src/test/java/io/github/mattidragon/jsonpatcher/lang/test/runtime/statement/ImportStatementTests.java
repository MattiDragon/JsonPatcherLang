...
public class ImportStatementTests {
    ...
    public void testSimpleImport() {
        ...
        new ImportStatement("lib_name", "test", TestUtils.POS, TestUtils.POS, TestUtils.POS).run(context);
        ...
        Assertions.assertThrowsExactly(EvaluationException.class, () -> new ImportStatement("lib_name", "test2", TestUtils.POS, TestUtils.POS, TestUtils.POS).run(context), "Import fail to overwrite existing variables");
    }
}
