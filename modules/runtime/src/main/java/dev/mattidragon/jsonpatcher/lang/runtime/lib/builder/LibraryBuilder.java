...
public class LibraryBuilder {
    ...
    private void buildFunctions() {
        ...
        methods.forEach((name, overloads) -> {
            ...
            functions.put(name, (context, args) -> {
                ...
                var hasContext = overload.getParameterTypes().length > 0 && overload.getParameterTypes()[0] == EvaluationContext.class;
                ...
                try {
                    ...
                    if (e.getCause() instanceof RuntimeException e1) {
                        if (overload.getAnnotation(DisableErrorWrapping.class) != null) {
                            throw e1;
                        }
    ...
    private static HashMap<Integer, Method> groupOverloadsByArgCount(String name, List<Method> overloads) {
        ...
        for (var overload : overloads) {
            ...
            if (argCount >= 1 && overload.getParameterTypes()[0] == EvaluationContext.class) {
                argCount--;
            }
    ...
    private HashMap<String, List<Method>> findMethods() {
        ...
        for (var method : libraryClass.getDeclaredMethods()) {
            ...
            for (int i = 0; i < parameterTypes.length; i++) {
                ...
                if (i == 0 && type == EvaluationContext.class) {
                    continue;
                }
