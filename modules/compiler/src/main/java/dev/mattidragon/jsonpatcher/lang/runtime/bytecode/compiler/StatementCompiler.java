...
public class StatementCompiler implements Opcodes {
    ...
    private void compileForEach(ForEachLoopStatement statement) {
        ...
        visitor.visitTypeInsn(CHECKCAST, Types.ARRAY_VALUE.getInternalName());
        visitor.visitMethodInsn(INVOKEVIRTUAL, Types.ARRAY_VALUE.getInternalName(), "value", Type.getMethodDescriptor(Type.getType(List.class)), false);
