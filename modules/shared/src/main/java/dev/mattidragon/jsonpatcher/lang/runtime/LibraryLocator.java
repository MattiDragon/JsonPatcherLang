...
public interface LibraryLocator {
     ...
     * All errors thrown during library loading should be {@link FunctionContext#createException(String) created with} the passed {@code context} object 
     ...
     */
    void loadLibrary(String libraryName, Value.ObjectValue libraryObject, FunctionContext context);
}
